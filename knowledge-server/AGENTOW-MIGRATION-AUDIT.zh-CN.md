...
覆盖更新：2026-09-15；源清单审计：2026-09-14。源：[kaixun96/dev.AgentOW，固定提交 7896845e51d75b0b9d632a2fd61876bc2f556ea5](https://github.com/kaixun96/dev.AgentOW/tree/7896845e51d75b0b9d632a2fd61876bc2f556ea5)。目标为当前 authored 包，三个包均为 `0.1.2`，精确依赖已协调。规则迁移在 `0.1.1` 交付；`0.1.2` 增加发现元数据，不改变该覆盖范围。本地链接指向已实现正文；消费方实际读取的快照由生成引用另行标识。
