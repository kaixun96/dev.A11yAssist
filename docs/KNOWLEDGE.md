...
- MAS/WCAG source lookup follows [Liquid standards retrieval](LIQUID-STANDARDS.md)
  ...
  No MCP server is auto-registered, no token is shipped, and no internal standards
  bodies are mirrored. Offline guidance remains usable without this optional
