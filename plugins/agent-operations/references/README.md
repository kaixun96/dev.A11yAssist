...
tools agent_operations_knowledge_list, agent_operations_knowledge_search(query), and
agent_operations_knowledge_read(id). A knowledge tool call automatically resolves and
