# Bug Bash: execution contracts and qualification

**English** | [简体中文](BUG-BASH-EXECUTION-DESIGN.zh-CN.md)
...
capabilities, composition, usage and outputs. Publishing either document does
not install or qualify any proposed capability.
...
## 2. Design principles and compatibility

Compose verifiable scenarios through stable capability contracts. The model
proposes scenarios and routing; the trusted runtime enforces authority, evidence,
resource ownership and completion. Keep routing and cross-cutting A11y knowledge
inline, load scenario details on demand and use deterministic tools for probes.
Isolate substantial reasoning procedures only when their inputs and outputs justify
...
An MCP task handle does not prove desktop ownership, correct evidence, cleanup or
delivery. Enforce permissions at the host/provider boundary; skill `allowed-tools`
metadata is not a security boundary. Packages must remain self-contained, but
installation alone does not schedule work or establish actual-host readiness.
...
replacement framework. Declared prerequisites govern activation. Reject incompatible
...
installs; do not add a workflow engine or hosted agent platform; keep report private;
...
Apply issue history and edit budgets through reviewed changes; an optimizer
must not edit the checker.
...
Background reading only; these sources do not demonstrate Bug Bash readiness or
measured gains. Implementation and acceptance requirements are defined above.

- [Large-plugin design and maintenance method](COMPOSABLE-PLUGIN-DESIGN.md).
  Its [final source register](COMPOSABLE-PLUGIN-DESIGN.md#10-primary-sources-and-evidence-limits)
  records DeepSeek Harness/Cordis, the harness-convergence study, Subagents vs
  Agent Skills, SE-GoS, SkillAdam and Funes, with review scope and evidence limits.
- [GitHub: Creating a Copilot CLI plugin](https://docs.github.com/en/copilot/how-tos/copilot-cli/customize-copilot/plugins-creating).
- [Agent Skills specification](https://agentskills.io/specification).
- [MCP architecture](https://modelcontextprotocol.io/docs/2026-07-28/learn/architecture)
  (2026-07-28 reference; not a declaration of installed-host compatibility).
