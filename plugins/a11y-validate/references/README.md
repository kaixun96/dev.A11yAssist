...
tools a11y_validate_knowledge_list, a11y_validate_knowledge_search(query), and
a11y_validate_knowledge_read(id). A knowledge tool call automatically resolves and
