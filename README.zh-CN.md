...
| [a11y-test-categories](plugins/a11y-test-categories/README.zh-CN.md) | 对范围内每个对象和可达状态，逐项执行全部九类无障碍测试规程 | Feature 范围和对象/状态清单；本地覆盖核对需要 Node.js 22+；现场检查需要获授权的浏览器/AT 工具及资源归属 |
